    ...
    <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <h2 class="text-center text-dark mt-5">UPDATE YOUR DETAILS</h2>
            ...
            <div class="card my-5">
              ...
              <form class="card-body cardbody-color p-lg-5" method="POST" >
                ...
                session_start();
                $id=$_SESSION["id"];
                $sql="select * from login_details where userid='$id'";
        ...
        <?php
          ...
          {
             $name1=$_POST['editname'];
             $address1=$_POST['editaddress'];
             $pincode1=$_POST['editpincode'];
             $state1=$_POST['editstate'];
             $city1=$_POST['editcity'];
             $phone1=$_POST['editphone'];
             $email1=$_POST['editemail'];
             $userid1=$_POST['edituserid'];
             $password1=$_POST['edituserpassword'];

             $update="update login_details set name='$name1',address='$address1',pincode='$pincode1',state='$state1',city='$city1',phoneno='$phone1',email='$email1',userid='$userid1',password='$password1' where userid='$id'";
